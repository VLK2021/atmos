...
export const HistoryTemperatureChart = ({ days, t }: Props) => {
        ...
        >
            <div>
                <h2 className="text-base font-semibold">
                    {t.historyTemperatureTrend}
                </h2>

                <p className="mt-0.5 text-xs text-[var(--color-text-muted)]">
                    {t.highestTemperature}, {t.lowestTemperature}, {t.avgTemp}
                </p>
            </div>
            ...
            <div className="mt-4 h-[300px] min-w-0">
                <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={chartData}>
                        <defs>
                            <linearGradient id="historyMax" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor="#F59E0B" stopOpacity={0.5} />
                                <stop offset="95%" stopColor="#F59E0B" stopOpacity={0} />
                            </linearGradient>

                            <linearGradient id="historyMin" x1="0" y1="0" x2="0" y2="1">

                ...
                {days.map((day, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="grid min-w-0 grid-cols-[minmax(90px,1fr)_38px_minmax(95px,1fr)_64px] items-center gap-3 rounded-2xl border border-white/5 bg-white/5 px-3 py-2.5 transition hover:bg-white/10 max-sm:grid-cols-[1fr_36px_52px]"
                        >

...
export const ForecastHourlyTimeline = ({ hours, t }: Props) => {
    return (
        <motion.section
        ...
        >
            ...
            <p className="mt-0.5 text-xs text-[var(--color-text-muted)]">
                24-hour temperature, rain and wind timeline
            </p>
                ...
                {hours.map((hour, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="min-w-[132px] rounded-3xl border border-[var(--color-border)] bg-white/10 p-3 transition hover:-translate-y-0.5 hover:bg-white/15"
                        >
                            ...
                            <div className="mt-3 space-y-1.5 text-xs text-[var(--color-text-muted)]">
                                <p className="flex items-center gap-1.5">
                                    ...
                                    {t.feelsLike} {Math.round(hour.feelslike_c)}°
                                </p>
